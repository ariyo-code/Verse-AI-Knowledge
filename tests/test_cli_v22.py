...
p=build_parser()
for args in [
 ['search','vehicle ownership'],['context','phone ui'],['api','GetFortCharacter'],['errors','x'],
 ['project','scan','.'],['verify','README.md'],['lab','next'],['lab','status'],['maintenance','check'],['doctor'],['validate']
]:
