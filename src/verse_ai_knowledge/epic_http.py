...
def fetch_epic(url: str, *, timeout: int=20, max_bytes: int=DEFAULT_MAX_BYTES, allowed_content_types: Iterable[str]=DEFAULT_CONTENT_TYPES, user_agent: str='Verse-AI-Knowledge-V25/1.0') -> tuple[bytes, str, str | None]:
